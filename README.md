...
To download a specific version of BDEv, which is the recommended approach, you must clone a specific tag from the github repository instead of cloning the master branch. For example, you can download version 3.7 by executing:

```
git clone --branch v3.7 https://github.com/rreye/bdev.git
```
...
```
git clone --branch v3.7 --recurse-submodules https://github.com/rreye/bdev.git
```
