...
To download a specific version of BDEv, which is the recommended approach, you must clone a specific tag from the github repository instead of cloning the master branch. For example, you can download version 3.8 by executing:

```
git clone --branch v3.8 https://github.com/rreye/bdev.git
```
...
```
git clone --branch v3.8 --recurse-submodules https://github.com/rreye/bdev.git
```
