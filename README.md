...
To download a specific version of BDEv, which is the recommended approach, you must clone a specific tag from the git repository instead of cloning the master branch. For example, you can download version 4.1.0 by executing:

```
git clone --branch v4.1.0 https://github.com/UDC-GAC/bdev.git
```
...
```
git clone --branch v4.1.0 --recurse-submodules https://github.com/UDC-GAC/bdev.git
```
