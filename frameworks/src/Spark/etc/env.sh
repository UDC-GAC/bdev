...
export SOLUTION_LOG_DIR="$SOLUTION_REPORT_DIR/logs/spark"
export SOLUTION_LIB_DIR="$SOLUTION_REPORT_DIR/lib"
export SOLUTION_BENCH_DIR="$BENCHMARKS_DIR/Spark"
export MASTERFILE="$SOLUTION_CONF_DIR/masters"
export WORKERSFILE="$SOLUTION_CONF_DIR/workers"

#SPARK
export SPARK_HOME="$SOLUTION_HOME"
export SPARK_CONF_DIR="$SOLUTION_CONF_DIR"
export SPARK_LOG_DIR="$SOLUTION_LOG_DIR"
export SPARK_LIB_DIR="$SOLUTION_LIB_DIR"
