...
export FRAMEWORK_TEMPLATE_DIR="$TEMPLATES_DIR/Flink"
export FRAMEWORK_CONF_DIR_SRC="$FRAMEWORK_HOME/conf"
export FRAMEWORK_CONF_DIR="$FRAMEWORK_REPORT_DIR/conf/flink"
export FRAMEWORK_LOG_DIR="$FRAMEWORK_REPORT_DIR/logs/flink"
export FRAMEWORK_LIB_DIR="$FRAMEWORK_REPORT_DIR/lib/flink"
export FRAMEWORK_BENCH_DIR="$BENCHMARKS_DIR/Flink"
export MASTERFILE="$FRAMEWORK_CONF_DIR/masters"
export WORKERSFILE="$FRAMEWORK_CONF_DIR/workers"

#FLINK
export FLINK_HOME="$FRAMEWORK_HOME"
export FLINK_CONF_DIR="$FRAMEWORK_CONF_DIR"
export FLINK_LOG_DIR="$FRAMEWORK_LOG_DIR"
export FLINK_LIB_DIR="$FRAMEWORK_LIB_DIR"
export PATH="$FLINK_HOME/bin:$PATH"
export FLINK_SSH_OPTS="${BDEV_SSH_OPTS}"
export FLINK_CONFIG_YAML_FILE="$FRAMEWORK_CONF_DIR/flink-conf.yaml"
export FLINK_VERSION="${FRAMEWORK_HOME##*/}"
