...
public class PagerankNaive extends Configured implements Tool 
{
    ...
    public int run (final String[] args) throws Exception
    {
		...
		if( args[6].startsWith("cont") ) {
			...
			System.out.println("Starting from cur_iter = " + cur_iteration);
		}

		//local_output_path = "pr_output_temp";

		converge_threshold = ((double)1.0/(double) number_nodes)/10;

		System.out.println("\n-----===[PEGASUS: A Peta-Scale Graph Mining System]===-----\n");
		System.out.println("[PEGASUS] Computing PageRank. Max iteration = " +niteration+ ", edge_path = "+args[0]+", threshold = " +converge_threshold+ ", reducers = " +nreducers+ "\n");
